...
//#define DEBUG_SELECTED	(GUI + KEYBOARD)
//#define DEBUG_SELECTED	(GUI)
//#define DEBUG_SELECTED	(KEYBOARD)
//#define DEBUG_SELECTED	(LCD + ENCODER)
//#define DEBUG_SELECTED	(LCD)
//#define DEBUG_SELECTED	(GUI + CAL + TOUCH + LCD + ENCODER + KEYBOARD + INIT + RS_HFIQ + CONTROL)
//#define DEBUG_SELECTED (GUI + TOUCH + LCD + KEYBOARD + ENCODER)
//#define DEBUG_SELECTED (TOUCH)
//#define DEBUG_SELECTED (CONTROL)
//#define DEBUG_SELECTED	(INIT + RS_HFIQ)
//#define DEBUG_SELECTED	(INIT + GUI)
//#define DEBUG_SELECTED	(RS_HFIQ)
//#define DEBUG_SELECTED	(WATCHDOG)
...
)
{
	if ((debug_code & DEBUG_SELECTED) != NONE) {
		...
		if (debug_code & CONTROL)
			xprintf ("Debug ChangeOver: ");
		if (debug_code & RS_HFIQ)
					xprintf ("Debug RS_HFIQ: ");
