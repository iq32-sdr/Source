...
//#define LCD_ROTATION 90 // *** clean after changing this to ensure that Eclipse is with the program ;-) DFM
//#define RS-HFIQ // Set encoder pins and display for HS-RFIQ board layout
